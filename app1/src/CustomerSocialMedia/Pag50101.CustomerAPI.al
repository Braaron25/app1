page 50202 CustomerAPI
{
    APIGroup = 'localization';
    APIPublisher = 'Altioracorp';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'customerAPI';
    DelayedInsert = true;
    EntityName = 'Cliente';
    EntitySetName = 'Clientes';
    PageType = API;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field(socialMediaCode1; Rec."Social Media Code 1")
                {
                    Caption = 'Código de Red Social 1';
                }
                field(socialMediaCode2; Rec."Social Media Code 2")
                {
                    Caption = 'Código de Red Social 2';
                }
                field(socialMediaLink1; Rec."Social Media Link 1")
                {
                    Caption = 'Link Red Social 1';
                }
                field(socialMediaLink2; Rec."Social Media Link 2")
                {
